    ...
    return (
        <div className='flex justify-between items-center h-16 fixed w-full z-20 bg-background px-5 border-b'>
            <div className='flex justify-center items-center gap-2'>
                <button onClick={toggleSidebar} className='md:hidden text-foreground' type='button'>
                    <AiOutlineMenu />
                </button>
                <Link to={RouteIndex}>
                    <img src={logo2} className='md:w-auto w-48' />
                </Link>
            </div>
            ...
            <div className='flex items-center gap-5'>
                <ThemeToggle />
                <button onClick={toggleSearch} type='button' className='md:hidden block text-foreground'>
                    <IoMdSearch size={25} />
                </button>

                {!user.isLoggedIn ?
                    <Button asChild className="rounded-full">
                        <Link to={RouteSignIn} className="text-foreground">
                            <MdLogin />
                            Sign In
                        </Link>
                    </Button>
